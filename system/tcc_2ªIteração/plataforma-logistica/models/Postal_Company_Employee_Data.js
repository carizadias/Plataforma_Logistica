...
module.exports = (sequelize, DataTypes) => {
    ...
    PostalCompanyEmployeeData.associate = (models) => {
        PostalCompanyEmployeeData.belongsTo(models.User, {
            foreignKey: 'user_id',
            as: 'user'
        });

        PostalCompanyEmployeeData.belongsTo(models.PostalCompany, {
            foreignKey: 'postal_company_id',
            as: 'postal_company'
        });

        PostalCompanyEmployeeData.belongsTo(models.PostOffice, {
